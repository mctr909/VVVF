...
namespace VVVF {
	class VvvfOut : WaveOut {
		...
		const double MIN_POWER = 0.10;
		const double FREQ_AT_MAX_POWER = 50.0;
		const byte WAVE_STEPS = 96;
		readonly sbyte[] SIN_TABLE = new sbyte[] {
			0, 13, 27, 39, 52, 63,74, 84, 93, 100, 107, 113,
			117, 121, 123, 125, 126, 127,127, 127, 127, 127, 127, 126,
			126, 126, 127, 127, 127, 127,127, 127, 126, 125, 123, 121,
			117, 113, 107, 100, 93, 84,74, 63, 52, 39, 27, 13,
			0, -13, -27, -39, -52, -63,-74, -84, -93, -100, -107, -113,
			-117, -121, -123, -125, -126, -127,-127, -127, -127, -127, -127, -126,
			-126, -126, -127, -127, -127, -127,-127, -127, -126, -125, -123, -121,
			-117, -113, -107, -100, -93, -84,-74, -63, -52, -39, -27, -13, 0
		};
		...
		protected override void SetData() {
			...
			for (int i = 0; i < mWaveBuffer.Length; i += 2) {
...

				{
					...
					setCarrierFreqGTO2(CurrentFreq);
				...
				var idxVa = (int)m_index + 32;
				var idxWa = (int)m_index + 64;
				if (idxVa >= WAVE_STEPS) {
					idxVa -= WAVE_STEPS;
				}
				if (idxWa >= WAVE_STEPS) {
